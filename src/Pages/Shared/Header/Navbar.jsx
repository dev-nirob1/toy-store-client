  ...
  const navItems = <>
    ...
    {user?.email &&
      <>
        ...
        <li><Link className=" text-gray-200  border md:border-none py-2 md:py-0 my-2 md:my-0 hover:text-gray-300" to="/myToy">My Toys</Link></li>
        <li><Link className=" text-gray-200  border md:border-none py-2 md:py-0 my-2 md:my-0 hover:text-gray-300" to="/allToy">All Toys</Link></li>
      </>
    }
  </>
